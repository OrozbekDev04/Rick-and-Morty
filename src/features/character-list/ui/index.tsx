      ...
      <div className="flex flex-wrap w-5/5 justify-center items-center gap-3 ">
        {currentCharacters.length > 0 ? (
          currentCharacters.map((char) => (
            <div
              key={char?.id}
              className="w-[280px] h-[430px] rounded p-2 border flex flex-col items-center justify-center hover:opacity-60 active:bg-gray-300"
            >
        ...
        <div className="flex gap-4 ">
          ...
          {paginationRange?.map((page) => (
            <button
              ...
              className={`w-[40px] h-[40px] text-2xl px-3  py-2 border rounded ${
